            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "deflection_limit_numerator": { "type": "integer", "minimum": 0,
                        "description": "Noemer x in de eis L/x; alleen gebruikt bij klasse 'Custom', en dan voor w_fin en w_add samen." },
