...
fn portal_beam1_bending() {
    let r = run();
    // referentie: M_y,c,Rd = 209.094 kNm (Wpl=889763 mm³)
    // Our profile DB: Wpl=845000 mm³ → M_y,c,Rd = 198.575 kNm
    // TODO Phase 13: align UNP350 Wpl in profile DB (845000 vs referentie 889763 mm³)
    assert_relative_eq!(resistance_value(r, "6.2.5_bending_y"), 198.575, max_relative = 1e-3);
    // UC = 194.796 / 198.575 = 0.981 (vs referentie 0.93 due to different Wpl)
