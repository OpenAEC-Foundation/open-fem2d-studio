...
fn portal_beam1_governing_ok() {
    ...
    // Our result: UC~1.33 due to profile DB differences (UNP350 Wpl=845000 vs XFrame 889763 mm³)
    ...
    // XFrame expects Ok but we currently compute NotOk due to profile DB delta — not a bug per se.
}
