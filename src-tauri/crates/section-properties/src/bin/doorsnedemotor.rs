...
use section_properties::composite::{CatalogusDeel, CompositeSection, GeslotenCel, Lamella};
use section_properties::contour::{Contour, Doorsnede, Segment};
use section_properties::motor::{self, Afschuiving, Profielvorm};
...
mod tests {
    use super::*;
    use section_properties::contour::{buis, i_profiel, koker_en10210, rechthoek, unp};
    ...
    fn uitsnede_door_de_uitronding_splitst_bogen() {
        ...
        let t = section_properties::torsie::bereken(&d);
