...
mod tests {
    ...
    /// Note: referentie uses C1=1.803 (from full NB.153 table for psi=0); our
    /// simplified formula gives 1.88. We test C with the referentie C1 value.
    #[test]
    fn calc2_beam1_ltb_intermediates() {
        ...
        let c1_referentie = 1.803;
        let c = c_coefficient(c1_referentie, 2500.0, 2500.0, 687.0, 0.0);
