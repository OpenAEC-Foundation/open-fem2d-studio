...
- [ ] **R1. Rapport-raamwerk.** `ReportPreview` wordt het live HTML-rapport:
...
- [ ] **R2. Invoersecties.** Projectblok (gegevens + instelbare koptekst/logo
...
- [ ] **R3. Resultaatsecties.** Constructieschets op schaal (SVG),
  ...
  combinatie.
- [ ] **R4. Toetsingssecties.** Twee detailniveaus per rapport instelbaar:
